...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SerializableJs2 = _interopRequireDefault(_SerializableJs);
	...
	var serializedData = JSON.parse(demoObj.serialize());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$getOwnPropertyNames = __webpack_require__(31)['default'];

	var _Set = __webpack_require__(35)['default'];

	var _getIterator = __webpack_require__(64)['default'];

	exports.__esModule = true;
	var ttp = _Symbol('TinyTrait properties');

	var TinyTrait = (function () {
		function TinyTrait() {
			_classCallCheck(this, TinyTrait);
		}

		TinyTrait.existsIn = function existsIn(object) {
			return TinyTrait.hasTrait(object, this);
		};

		TinyTrait.applyTo = function applyTo(implementor, overwrite) {

			var propertyNames = _Object$getOwnPropertyNames(this.prototype);
			var i = undefined,
			    propCount = undefined;
			...
			if (!implementor[ttp].traits) {
				implementor[ttp].traits = new _Set();
			}
		...
		TinyTrait.acquire = function acquire(implementor) {

			var postInitializers = [];

			for (var _len = arguments.length, traits = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
				traits[_key - 1] = arguments[_key];
			}

			for (var _iterator = traits, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _getIterator(_iterator);;) {
				var _ref;
			...
			for (var _iterator2 = postInitializers, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _getIterator(_iterator2);;) {
				var _ref2;
		...
		TinyTrait.hasTrait = function hasTrait(object, trait) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!useNative){
	  ...
	  if(SUPPORT_DESC && !__webpack_require__(30)){
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 23.2 Set Objects
	__webpack_require__(61)('Set', function(get){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(NAME, wrapper, methods, common, IS_MAP, IS_WEAK){
	  var Base  = __webpack_require__(8)[NAME]
	    ...
	    , proto = C && C.prototype
	    , O     = {};
	  if(!__webpack_require__(10) || typeof C != 'function'
	    || !(IS_WEAK || proto.forEach && !__webpack_require__(11)(function(){ new C().entries().next(); }))
	  ){
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.P, 'Set', {toJSON: __webpack_require__(63)('Set')});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Serializable = (function (_TinyTrait) {
		_inherits(Serializable, _TinyTrait);

		function Serializable() {
			_classCallCheck(this, Serializable);

			_TinyTrait.apply(this, arguments);
		}

		Serializable.prototype.traitInitializer = function traitInitializer() {
		...
		Serializable.prototype.traitPostInit = function traitPostInit() {
			console.log('Post init');
		};

		Serializable.prototype.serialize = function serialize() {

			var data = {};

			if (this.serializable) {
				var properties = _Object$getOwnPropertyNames(this);
				for (var _iterator = properties, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _getIterator(_iterator);;) {
					var _ref;
		...
		Serializable.prototype.unserialize = function unserialize(data) {
